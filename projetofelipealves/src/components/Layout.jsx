    ...
    return (
        <div className={styles.Layout}>
            <div className={styles.cabecalho}>
                <Image src='/images/FELIPEALVESRBG2.png' width='250' height='100'/>
                <Link href="/">Cursos</Link>
                <Link href="quemSomos">Quem somos</Link>
                <Link href="/correcao">Correção de redação</Link>
                <Link href="/" className={styles.entrar}>Entrar</Link>
            ...
            <div style={{backgroundColor: '#373E48', color: 'white'}}>
                <div class="p-14 px-20">
                    <h1 class="font-Montserrant text-2xl">Curso Felipe Alves</h1>

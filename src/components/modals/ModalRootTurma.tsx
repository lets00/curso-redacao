    ...
    return(
        <div className="flex text-black gap-3 -ml-3 -mt-2">
            ...
            <div className="flex flex-col items-end gap-2 mt-12">
                <button className="bg-pink-500 text-white py-2 px-4 rounded-md font-bold">Deletar</button>
                <button className="bg-pink-500 text-white py-2 px-4 rounded-md font-bold">Editar</button>
            </div>
        </div>
    )
}